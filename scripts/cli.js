...
const contractABI = require("../artifacts/contracts/Blockchainscan.sol/Blockchainscan.json").abi;

program
    .name("blockchainscan-cli")
    .description("CLI tool for Blockchainscan smart contract")
    .version("1.0.0");
